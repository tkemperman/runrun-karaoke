...
- Find lyrics offers exact video matches from the built-in public catalog and always retains LRCLIB as an alternative. Use synchronized lyrics when available; do not assume complete catalog coverage.
